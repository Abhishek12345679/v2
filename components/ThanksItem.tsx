...
const ThanksItem = (props: ThanksItemProps) => {
  return (
    <article key={props.key} className="project-item">
      <div className="card">
        <Image
      ...
      <div className="flex">
        {props.repo_url!.length > 0 && props.github_url.length > 0 ? (
          <a
        ...
        {props.instagram_url!.length > 0 ? (
          <a
            className="margin-left-10 flex h-8 w-8 items-center justify-center rounded"
